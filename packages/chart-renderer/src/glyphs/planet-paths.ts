...
const NORTH_NODE_PATH = "M 50 15 C 30 15 15 30 15 50 C 15 70 30 85 50 85 C 70 85 85 70 85 50 C 85 30 70 15 50 15 Z M 13 20 L 13 13 L 20 13 L 20 17 L 17 17 L 17 20 Z M 80 13 L 87 13 L 87 20 L 83 20 L 83 17 L 80 17 Z M 48 85 L 52 85 L 52 95 L 48 95 Z";

const SOUTH_NODE_PATH = "M 50 85 C 70 85 85 70 85 50 C 85 30 70 15 50 15 C 30 15 15 30 15 50 C 15 70 30 85 50 85 Z M 13 80 L 13 87 L 20 87 L 20 83 L 17 83 L 17 80 Z M 80 87 L 87 87 L 87 80 L 83 80 L 83 83 L 80 83 Z M 48 5 L 52 5 L 52 15 L 48 15 Z";
...
export const PLANET_PATHS: Record<string, string> = {
  ...
  chiron:          "M 48 8 L 52 8 L 52 50 L 48 50 Z M 30 28 L 70 28 L 70 32 L 30 32 Z M 48 50 C 48 65 36 80 23 90 L 27 90 C 40 80 52 65 52 50 Z M 52 50 C 52 65 64 80 77 90 L 73 90 C 60 80 48 65 48 50 Z M 50 50 C 56 50 62 45 62 40 C 62 34 56 28 50 28 C 52 28 56 33 56 40 C 56 47 52 50 50 50 Z",
  lilith:          "M 50 8 C 65 8 78 20 78 36 C 78 52 65 64 50 64 C 35 64 22 52 22 36 C 22 20 35 8 50 8 Z M 48 64 L 52 64 L 52 92 L 48 92 Z M 35 76 L 65 76 L 65 80 L 35 80 Z",

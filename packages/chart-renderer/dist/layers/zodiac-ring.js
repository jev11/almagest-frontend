...
export function drawZodiacRing(ctx, data, theme, dim) {
    ...
    for (let i = 0; i < 12; i++) {
        ...
        const glyphPath = SIGN_GLYPHS[sign] ?? "";
        drawSignGlyph(ctx, glyphPath, glyphPos.x, glyphPos.y, GLYPH_SIZES.sign, theme.signGlyphColor);
    }
...
//# sourceMappingURL=zodiac-ring.js.map
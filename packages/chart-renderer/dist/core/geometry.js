 ...
 */
export function longitudeToAngle(longitude, ascendant) {
 ...
 */
export function drawArc(ctx, cx, cy, radius, startAngle, endAngle, counterClockwise = false) {
 ...
 */
export function signIndexFromLongitude(lon) {
